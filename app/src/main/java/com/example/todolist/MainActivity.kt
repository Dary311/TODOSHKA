...
class MainActivity : AppCompatActivity(), RecyclerViewEvent {
    ...
    //Инициализирует активность при создании, настраивает привязки и обработчики событий кнопок.
    ...
    //Обработчик нажатия на элемент списка, изменяет статус задачи (выполнена/не выполнена).
